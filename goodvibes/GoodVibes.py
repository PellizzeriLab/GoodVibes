...
def main():
    ...
    parser.add_argument("--cv", dest="Cv", action="store_true", default=False,
                        help="Compute the heat capacity")
    ...
    if options.temperature_interval is False:
        if options.spc is False:
            log.write("\n\n   ")
            if options.QH:
                log.write('{:<39} {:>13} {:>10} {:>13} {:>13} {:>10} {:>10} {:>13} {:>13} {:>13}'
                          '{:>13}'.format("Structure", "E", "ZPE", "H", "qh-H", "T.S", "T.qh-S", "G(T)", "qh-G(T)", "Cv", "qh-Cv"),
                          thermodata=True)
            else:
    ...
    if options.cv:
        ...
        log.write('{:<39} {:>13} {:>13}'.format("Structure", "Cv", "qh-Cv"), thermodata=True)
